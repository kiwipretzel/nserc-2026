This repo stores all codes, notebooks, and data files for my 2026 summer project. 

In this repo, I use two types of notebooks for different purposes:
1) Jupyter notebooks (running on UofT's servers) - plotting and (most) analytic computations
